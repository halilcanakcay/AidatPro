@extends('layouts.app', ['title' => 'Gider Ekle - AidatPro'])
...
@section('content')
        ...
        <div class="container-xl">
            <div class="row g-3 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Gider Ekle</h2>
                    <div class="text-secondary mt-1">Kasa bakiyesini doğru görmek için her harcamayı kaydedin.</div>
                </div>
    ...
    <div class="page-body">
        <div class="container-xl">
            <form class="card" method="post" action="{{ route('expenses.store') }}">
                @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" name="amount" min="0.01" step="0.01" value="{{ old('amount') }}" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control" name="description" value="{{ old('description') }}" placeholder="Örn: A Blok asansör bakımı" required>
                        </div>
                    </div>
                </div>
